...
type HelloServiceClient interface {
	Hello(ctx context.Context, in *Massage, opts ...grpc.CallOption) (*Massage, error)
}
...
type HelloServiceServer interface {
	Hello(context.Context, *Massage) (*Massage, error)
...
func (*UnimplementedHelloServiceServer) Hello(context.Context, *Massage) (*Massage, error) {
